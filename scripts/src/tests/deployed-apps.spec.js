...
test.describe("Deployed Applications Validation", () => {
  ...
  for (const testBrowser of ["chromium"]) {
    // Start with one browser
    test.describe(`${testBrowser} browser tests`, () => {
      deployedApps.forEach((app) => {
        test(`${app.name} should load and render correctly`, async ({
          page,
          browserName,
        }) => {
          test.skip(browserName !== testBrowser.replace("webkit", "safari"));
