...
const ROLLDOWN_LOGO = `<svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" viewBox="0 0 200 200"><circle cx="100" cy="100" r="90" fill="#ff4d4d"/><path fill="#fff" d="M60 70h80v20H80v20h40v20H60z"/></svg>`;

function App() {
  return (
    <ZephyrWelcome
      title="React + Rolldown"
      slug="bundlers/rolldown-react"
      bundlerName="Rolldown"
      frameworkLogo={`<a href="https://react.dev" target="_blank">${REACT_LOGO}</a>`}
      bundlerLogo={`<a href="https://rolldown.rs" target="_blank">${ROLLDOWN_LOGO}</a>`}
      pills={['React 19', 'Rolldown', 'TypeScript', 'Zephyr Cloud']}
    />
  );
}
