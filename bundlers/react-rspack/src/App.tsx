...
const RSPACK_LOGO = `<svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" viewBox="0 0 200 200"><path fill="#ff6e00" d="M170.7 29.3L100 0 29.3 29.3 0 100l29.3 70.7L100 200l70.7-29.3L200 100z"/><path fill="#fff" d="M100 40l-45 26v52l45 26 45-26V66z"/><path fill="#ff6e00" d="M100 60l-25 14.4v28.8L100 118l25-14.4V74.4z"/></svg>`;
...
function App() {
  return (
    <ZephyrWelcome
      ...
      bundlerLogo={`<a href="https://rspack.dev" target="_blank">${RSPACK_LOGO}</a>`}
      pills={['React 19', 'Rspack', 'TypeScript', 'Zephyr Cloud']}
    />
  );
}
