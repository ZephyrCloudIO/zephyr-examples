...
function App() {
  return (
    <ZephyrWelcome
      ...
      bundlerName="Rollup"
      frameworkLogo={`<a href="https://react.dev" target="_blank">${REACT_LOGO}</a>`}
      bundlerLogo={`<a href="https://rollupjs.org" target="_blank">${ROLLUP_LOGO}</a>`}
      pills={['React 19', 'Rollup', 'TypeScript', 'Zephyr Cloud']}
    />
  );
}
