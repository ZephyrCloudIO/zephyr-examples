...
const PARCEL_LOGO = `<svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" viewBox="0 0 128 128"><path fill="#e6a328" d="M64 0L16 28v72l48 28 48-28V28z"/><path fill="#fff" d="M64 16L32 34.5v59L64 112l32-18.5v-59z"/><path fill="#e6a328" d="M64 36v56l-20-11.5v-33z"/><path fill="#b5831b" d="M64 36l20 11.5v33L64 92z"/></svg>`;
...
export function App() {
  return (
    <ZephyrWelcome
      ...
      bundlerLogo={`<a href="https://parceljs.org" target="_blank">${PARCEL_LOGO}</a>`}
      pills={['React 19', 'Parcel', 'TypeScript', 'Zephyr Cloud']}
    />
  );
}
