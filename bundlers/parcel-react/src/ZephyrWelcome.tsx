...
export function ZephyrWelcome({ title, slug, bundlerName, frameworkLogo, bundlerLogo, pills }: ZephyrWelcomeProps) {
  ...
  useEffect(() => {
    ...
    setAttached(true);
  }, [attached, title, slug, bundlerName, frameworkLogo, bundlerLogo, pills]);
