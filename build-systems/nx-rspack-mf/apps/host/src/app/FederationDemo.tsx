    ...
    >
      ...
      <div style={{ maxWidth: '1040px', margin: '0 auto' }}>
          ...
          >
            {show1 && (
              <RemoteBoundary
                ...
                tagline="apps/remote1 · built & deployed independently"
              >
                <Remote1 />
              </RemoteBoundary>
            )}
            ...
            {show2 && (
              <RemoteBoundary
                ...
                tagline="apps/remote2 · built & deployed independently"
              >
                <Remote2 />
              </RemoteBoundary>
            )}
        ...
        >
          ...
          <code style={{ color: '#c7d2fe' }}>remote1/Module</code> and{' '}
          <code style={{ color: '#c7d2fe' }}>remote2/Module</code> at runtime. Rspack + Module
