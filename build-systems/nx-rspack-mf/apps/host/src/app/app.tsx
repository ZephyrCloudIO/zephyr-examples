...
const RSPACK_LOGO = `<img src="https://assets.rspack.rs/rspack/rspack-logo.svg" alt="Rspack" width="56" height="56" />`;

export function App() {
  return (
    <ZephyrWelcome
      title="Nx + Rspack + Module Federation"
      ...
      pills={['Nx 22', 'Rspack', 'Module Federation', 'React 19', 'TypeScript', 'Zephyr Cloud']}
      mid={<FederationDemo />}
    />
  );
}
