...
const MODERNJS_LOGO = `<svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" viewBox="0 0 200 200"><rect width="200" height="200" rx="20" fill="#1677ff"/><text x="100" y="120" text-anchor="middle" font-family="system-ui" font-weight="800" font-size="80" fill="#fff">M</text></svg>`;

const Index = () => (
  <ZephyrWelcome
    title="ModernJS"
    slug="frameworks/modernjs"
    bundlerName="ModernJS"
    frameworkLogo={`<a href="https://react.dev" target="_blank">${REACT_LOGO}</a>`}
    bundlerLogo={`<a href="https://modernjs.dev" target="_blank">${MODERNJS_LOGO}</a>`}
    pills={['React 19', 'ModernJS', 'TypeScript', 'Zephyr Cloud']}
  />
);
