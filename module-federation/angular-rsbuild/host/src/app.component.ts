    ...
    <main class="shell">
      ...
      <section class="hero">
        ...
        <div class="logos" aria-label="Technology stack">
          ...
          <span class="sep">+</span>
          <span class="logo rsbuild">R</span>
          <span class="sep">+</span>
          <span class="logo zephyr">Z</span>
        </div>

        <h1>Angular + Rsbuild <span>Module Federation</span></h1>
        <p class="sub">
      ...
      <section class="quickstart">
        ...
        <div>
          <code><span>$</span> pnpm dlx degit ZephyrCloudIO/zephyr-examples/module-federation/angular-rsbuild my-app</code>
        </div>
      </section>
      ...
      <section class="remote-slot" aria-label="Federated remote component">
        <div class="section-heading">
          ...
          <p>The card is compiled and served by <code>angular_rsbuild_remote</code>.</p>
        </div>
        @if (remoteComponent()) {
      ...
      <section class="cards">
        <article>
          <span>1</span>
          <h3>Built</h3>
          <p>Angular is compiled through Rsbuild with federation config.</p>
        </article>
        <article>
          <span>2</span>
          <h3>Uploaded</h3>
...
export class AppComponent {
  ...
  private async loadRemote(): Promise<void> {
    const remote = await import('angular_rsbuild_remote/PromoCard');
